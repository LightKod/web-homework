...
export default function FilterTask({
    ...
    const handleSubmit = (event: FormEvent) => {
        ...
        if(taskState !== "") {
            filter.completed = taskState === "completed"
        }
